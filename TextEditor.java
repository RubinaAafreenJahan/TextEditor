...
public class TextEditor extends JFrame {
	...
	public static final String APP_NAME = "Text Editor....@RSSS";//title
  
	public static final String FONTS[] = { "Serif", "SansSerif", "Courier" };//font styles
	...
	protected JMenuBar createMenuBar() {
		...
		mEdit.setMnemonic('e');
		//icon for new option on tool bar
		ImageIcon iconNew = new ImageIcon("//SHIVAMDHAR/Users/Shivam Dhar/Downloads/JTEditor/new.gif");
		...
		//icon for new in list
		JMenuItem item = new JMenuItem(actionNew);
		item.setIcon(new ImageIcon("//SHIVAMDHAR/Users/Shivam Dhar/Downloads/JTEditor/new.gif"));
		item.setMnemonic('n');
		item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
				InputEvent.CTRL_MASK));
		mFile.add(item);
		//icon for open
		ImageIcon iconOpen = new ImageIcon("//SHIVAMDHAR/Users/Shivam Dhar/Downloads/JTEditor/open.gif");
		...
		mFile.add(item);
		//icon for save
		ImageIcon iconSave = new ImageIcon("//SHIVAMDHAR/Users/Shivam Dhar/Downloads/JTEditor/save.gif");
      ...
      bar.add(editMenu);
		...
		menuBar.add(mFont);
		//icon for bold
		ImageIcon img1 = new ImageIcon("C:/Users/Shivam Dhar/Documents/Bluetooth Folder/text_bold.png");
		...
		//icon for italics
		img1 = new ImageIcon("C:/Users/Shivam Dhar/Documents/Bluetooth Folder/text_italics.png");
